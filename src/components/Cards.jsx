    ...
    <div className='w-full h-screen bg-zinc-900 flex gap-5 items-center px-32'>
        <div className="cardcontainer h-[55vh] w-1/2">
            <div className="card relative rounded-xl w-full h-full bg-[#004d43] flex items-center justify-center">
                ...
                <button className='absolute left-10 bottom-10 px-5 py-1 border-2 rounded-full uppercase'>hey</button>
            </div>
        </div>
        ...
        <div className=" cardcontainer  h-[55vh] w-1/2 flex gap-5">
            <div className="card relative rounded-xl w-full h-full bg-[#192826] flex items-center justify-center">
                ...
                <button className='absolute left-10 bottom-10 px-5 py-1 border-2 rounded-full uppercase'>rating 5.0 on clutch</button>
            </div>
            <div className="card relative rounded-xl w-full h-full bg-[#192826] flex items-center justify-center">
                <img src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" />
                <button className='absolute left-10 bottom-10 px-5 py-1 border-2 rounded-full uppercase'>business bootcamp alumni</button    >    
            </div>         
        </div>
    </div>
  )
